...
#import "PhotoEditorViewCtrl.h"
#import "UIImage+Extensions.h"

@interface PhotoEditorViewCtrl ()
{
...
@implementation PhotoEditorViewCtrl{
...
-(IBAction) cornerViewMoved:(UIPanGestureRecognizer*)pan{
    ...
    NSLog(@"point is %@",NSStringFromCGPoint([pan translationInView:self.drawView]));
    if (pan.view==arrow1){
